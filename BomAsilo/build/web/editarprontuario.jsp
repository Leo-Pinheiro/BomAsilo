                ...
                <body>
                    ...
                    <form action="recebeeditaprontuario.jsp" method="POST">
                        ...
                        <input type="text"  name="tiposangue" maxlength="3" 
                               value="<%out.write(p.getTipoSangue());%>"/><br />
                        
                        <label>Peso</label>
                        <input type="text" name="peso"
                               value="<%out.write("" + p.getPeso());%>"/><br />
                        
                        <label>Altura</label>
                        <input type="text" name="altura" maxlength="99" 
                               value="<%out.write("" + p.getAltura());%>"/><br />
                        ...
                        <input type="checkbox" 
                               ...
                               %>
                               >Limitação Auditiva?  </input> <br />
                        
                        <label>Outra Limitação</label>
                        <input type="text" name="limitOutras"
                               value="<%out.write(p.getLimitOutras());%>" /> <br />
                        
                        <label>Alergia</label>
                        <input type="text" name="descAlergia"
                               value="<%out.write(p.getDescAlergia());%>" /> <br />
                        
                        <label>Ocupação</label>
                        <input type="text" name="descOcupacao" 
                               value="<%out.write(p.getDescOcupacao());%>"/> <br /> <hr />
