    ...
    <body>
        ...
        //recebe os valores da tela HTML 
            ...
            if(paciente.alterarPaciente()){
                response.sendRedirect("familiarvisualizarpacienteEN.jsp?pmensagem=" +URLEncoder.encode("Patient Saved", "UTF-8"));
            } else {
                response.sendRedirect("familiarvisualizarpacienteEN.jsp?pmensagem=" +URLEncoder.encode("Error in Saving Patient", "UTF-8"));
            }          
        %>        
