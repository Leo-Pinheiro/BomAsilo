                ...
                <body>
                    ...
                    <form action="recebeeditausuario.jsp" method="POST">
                        ...
                        <input type="text" name="emailUsuario" 
                                value="<%out.write(u.getEmailUsuario());%>" /><br />
                        
                        <label>Login</label>
                        <input type="text" name="login" 
                               value="<%out.write(u.getLogin());%>" /><br />
                        
                        <label>Senha</label>
                        <input type="password" name="senha" 
                               value="<%out.write(u.getSenha());%>" /><br />
...
                        <label for="profSaude"><input type="radio" id="proSaude" name="tipoAcesso" value="profsaude" <%=checkedPSaude%> >Prof. Saúde</label><br><br><hr />
