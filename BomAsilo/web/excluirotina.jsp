    ...
    <body>
        ...
        <%
            ...
            if (pIdEvento != null) {
                ...
                if (r.excluirRotina()) {
                    response.sendRedirect("consultarotina.jsp?pmensagem=Rotina excluido com sucesso");
                } else {
                    response.sendRedirect("consultarotina.jsp?pmensagem=Problemas ao excluir rotina");
                }
            }
        %>
        <hr />
