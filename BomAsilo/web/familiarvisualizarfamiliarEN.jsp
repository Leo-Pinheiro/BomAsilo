...
<html>
    ...
    <body>
        ...
        <div class="container">
            <form action="recebeeditavisufamiliarEN.jsp"  method="POST" id="bomasilo" action="">
                <h3>My Info</h3><br/>
                ...
                <input type="submit" value="Edit" onclick="window.top.location.href = 'familiarvisualizarfamiliarEN.jsp';"/>
    ...
    <script>
        if (document.getElementByName("foneFixo").value === "") {
            document.getElementByName("validafonefixo").innerHTML = "Enter Phone Number";
            foneFixo[0].focus();
            exit(0);
        }

        if (document.getElementByName("foneCelular").value === "") {
            document.getElementByName("validafonecelular").innerHTML = "Enter Phone Number 2";
            foneCelular[0].focus();
            exit(0);
        }
