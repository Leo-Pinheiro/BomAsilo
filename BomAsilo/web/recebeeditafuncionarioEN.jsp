    ...
    <%
        //recebe os valores da tela HTML 
            ...
            if(fun.alterarFuncionario()){
                ...
                response.sendRedirect("consultafuncionarioEN.jsp?pmensagem=" +URLEncoder.encode("Worker Saved", "UTF-8"));
            } else {
                response.setCharacterEncoding("UTF-8");
                response.sendRedirect("consultafuncionarioEN.jsp?pmensagem=" +URLEncoder.encode("Error in Saving Worker", "UTF-8"));
            }          
        %>        
      </body>
</html>
