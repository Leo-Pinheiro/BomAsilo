    ...
    <section>
        ...
        <article>
            <body>
                ...
                %>
                <form action="recebeeditausuarioEN.jsp" method="POST">
                    ...
                    <br />
                    <hr />
                    <input type="submit" value="Edit" onclick="window.location.href= 'consultausuarioEN.jsp';"/>
                    <input type="reset" value="Cancel" onclick="window.location.href = 'consultausuarioEN.jsp';" />
